...
{
    public class StingerBlade : ModProjectile
    {
        ...
        public override void AI() {
            ...
            // Enable green sword glow effect on the player while swinging
            if (player.active && player.whoAmI == Main.myPlayer) {
                player.GetModPlayer<ObsidianSwordPlayer>().greenSwordGlow = true;
            }
        ...
        // Apply poison debuff to hit NPCs
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
            target.AddBuff(BuffID.Poisoned, 180);
        }

        // Draw a green glow overlay on the blade
        public override void PostDraw(Color lightColor) {
            ...
            Main.EntitySpriteDraw(
                ...
                null,
                Color.LimeGreen * Projectile.Opacity,
                Projectile.rotation,
                drawOrigin,
                Projectile.scale,
