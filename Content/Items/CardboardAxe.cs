...
{
    // Defines the CardboardAxe item for the mod
    public class CardboardAxe : ModItem
    {
        // Sets the default properties of the item
        public override void SetDefaults() {
            Item.damage = 8; // Base damage dealt by the axe
