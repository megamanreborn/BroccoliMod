...
{
    // Defines the CardboardHammer item for the mod
    public class CardboardHammer : ModItem
    {
        // Sets the default properties of the item
        public override void SetDefaults() {
            Item.damage = 8; // Base damage dealt by the hammer
        ...
        // Adds the crafting recipe for the CardboardHammer
